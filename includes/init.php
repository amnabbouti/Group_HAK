...
if (basename($_SERVER['PHP_SELF']) === 'admin.php' || basename($_SERVER['PHP_SELF']) === 'admin_register.php' || basename($_SERVER['PHP_SELF']) === 'form.php' || basename($_SERVER['PHP_SELF']) === 'edit.php' || basename($_SERVER['PHP_SELF']) === 'edit_user.php') {
